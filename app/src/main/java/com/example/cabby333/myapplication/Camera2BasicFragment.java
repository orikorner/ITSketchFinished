...
//    private AutoFitTextureView mTextureView;
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            Log.i(TAG, String.valueOf(im.getHeight()));
            Log.i(TAG, String.valueOf(im.getWidth()));
            try {
                mSketchSem.acquire();
...
//        String FileName = "pic_" + timeStamp + ".jpg";
        String name = String.valueOf(tmp_num) + "pic.jpg";
...
//                    mImageView.setMaxHeight(mPreviewSize.getHeight());
//                    mImageView.setMaxWidth(mPreviewSize.getWidth());
...
//                    Intent intent = new Intent(getActivity(), ImageSketchFragment.class);
//                    Bundle b = new Bundle();
...
//                    startActivity(intent);
                ...
                getActivity().getSupportFragmentManager().beginTransaction()
                        .replace(R.id.container, ImageSketchFragment.newInstance())
                        .addToBackStack(null).commit();

//                SketcherActivity.inCanvas = true;
